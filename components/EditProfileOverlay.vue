<template>
    <div id="EditProfileOverlay"
        ...
        <div class="relative bg-white dark:bg-black w-full max-w-[700px] sm:h-[580px] h-[655px] mx-3 p-4 rounded-lg mb-10"
            ...
            <div class="h-[calc(500px-200px)]" :class="!uploadedImage ? 'mt-16' : 'mt-[58px]'">
                <div v-if="!uploadedImage">
                    <div id="ProfilePhotoSection" class="flex flex-col border-b sm:h-[118px] h-[145px] px-1.5 py-2 w-full">
                        ...
                        <div class="flex items-center justify-center sm:-mt-6">
                            <label for="image" class="relative cursor-pointer">
                                ...
                                <div
                                    class="absolute bottom-0 right-0 rounded-full bg-white dark:bg-black shadow-xl border p-1 border-gray-300 inline-block w-[32px]">
                    ...
                    <div class="px-1.5 py-2 mt-2 justify-center">
                        <span
                            class="font-semibold text-[15px] sm:mb-0 mb-1 text-gray-700 sm:w-[160px] sm:text-left text-center">Profile
                            Color</span>
                        <input id="nativeColorPicker1" type="color" value="#6590D5" class="z-10 h-16 w-[61%] ml-[5.5%] " />
                    </div>
            ...
            <div id="ButtonSection" class="absolute p-5 left-0 bottom-0 border-t border-t-gray-300 w-full">
                <div id="UpdateInfoButtons" v-if="!uploadedImage" class="flex items-center justify-end">
                    ...
                    <button :disabled="!isUpdated" @click="updateUserInfo()"
                        :class="!isUpdated ? 'bg-gray-200' : 'bg-gray-700'"
                        class="flex items-center bg-[#f0cc2c] text-white border rounded-md ml-3 px-3 py-[6px]">
                        <span id="save" class=" mx-4 font-medium text-[15px]">Save</span>
                    </button>
                </div>
