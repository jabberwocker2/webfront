<template>
    <div id="PostPage"
        ...
        <div v-if="true" class="lg:w-[calc(100%-540px)] h-full relative">
            ...
            <video v-if="true" class="absolute w-full my-auto z-[-1] h-screen"
                src="https://drive.google.com/uc?export=download&id=1MYr_Y4SIUZvMJTdmPaJyoC-TFDukFw_z" />
            ...
            <div class="bg-black bg-opacity-70 lg:min-w-[480px]">
                <video v-if="true" ref="video" loop muted class="h-screen mx-auto"
                    src="https://drive.google.com/uc?export=download&id=1MYr_Y4SIUZvMJTdmPaJyoC-TFDukFw_z" />
            </div>
        ...
        <div id="InfoSection" v-if="true" class="lg:max-w-[550px] relative w-full h-full bg-white">
            ...
            <div class="flex items-center justify-between px-8">
                ...
                <Icon v-if="true" class="cursor-pointer" name="material-symbols:delete-outline-sharp" size="25" />
            </div>

            <div class="px-8 mt-4 text-sm">some text</div>
                    ...
                    <div class="flex items-center relative w-full">
                        ...
                        <div class="ml-14 pt-0.5 w-full">
                            <div class="text-[18px] font-semibold flex items-center justify-between">
                                name
                                <Icon v-if="true" name="material-symbols:delete-outline-sharp"
                                    size="25" />
                            </div>
            ...
            <div id="CreateComment" v-if="true"
                ...
                <button :class="comment ? 'text-[#F02C56] cursor-pointer' : 'text-gray-400'"
